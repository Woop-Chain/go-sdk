...
const (
	...
	defaultMainnetEndpoint = "https://rpc.woopchain.com/"
)
...
%s
./wiki --node=[NODE] balances <SOME_WOC_ADDRESS>
...
%s
./wiki --node=[NODE] staking create-validator --amount 10 --validator-addr <SOME_WOC_ADDRESS> \
