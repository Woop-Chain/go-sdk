...
func init() {
	cmdGovernance := &cobra.Command{
		...
		Long: `
Support interaction with the Woop governance space on Snapshot, especially for validators that do not want to import their account private key into either metamask or wocwallet.
`,
