...
Example:
    ./wiki-csv.py /path/to/csv/file.csv --node https://rpc.woopchain.com/
    ./wiki-csv.py /path/to/csv/file.csv --fast -n https://rpc.woopchain.com/
    ./wiki-csv.py /path/to/csv/file.csv --fast --use-default-passphrase --yes -n https://rpc.woopchain.com/
    ./wiki-csv.py /path/to/csv/file.csv --fast --use-default-passphrase --yes --batch-size 100 -n https://rpc.woopchain.com/
...
Install with:
    curl -O https://raw.githubusercontent.com/woop-chain/go-sdk/main/scripts/wiki-csv.py && chmod +x wiki-csv.py
"""
import sys
import time
import getpass
...
def _parse_args():
    ...
    parser.add_argument("--node", "-n", dest="node", default="https://rpc.woopchain.com/", type=str,
                        help="The node or endpoint to send the transactions to, default: 'https://rpc.woopchain.com/'.")
